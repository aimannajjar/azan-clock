...
static const TimezoneEntry timezone_map[] = {
    {"Africa/Abidjan", "GMT0"},
    {"Africa/Accra", "GMT0"},
...
int get_timezone_posix(const char *timezone_id, const char* ret_timezone_posix) {
    for (int i = 0; i < timezone_count; i++) {
        if (strcmp(timezone_map[i].timezone_id, timezone_id) == 0) {
            strcpy(ret_timezone_posix, timezone_map[i].posix_value);
            return i;
        }
    }
...
// Function to get the timezone posix from the index
void get_timezone_posix_from_index(int index, const char* ret_timezone_posix) {
    strcpy(ret_timezone_posix, timezone_map[index].posix_value);
}